...
*/
var procedure = function outputMary(){
...
function doStuff(callback){
    ...
    callback();//callback is the temporary name given to the argument
    console.log(callback.name, "was passed as an argument to this function");
     console.log(" ");
